...
lc.type = 1; % 1: random number generator 2: file from Steve 3: Stat Gen E-Field

switch lc.type
    case 1
        m_total = 1; % Number of loops to run
    case 2
        %         filename =
...
switch screen.type
    ...
    case 2
        ...
        screen1 = load('180210_1250 eighth_pi_max_change_screen.mat','screen');
        screen.phase = screen1.screen.phase;
    case 3
...
for m=1:m_total
    switch lc.type
        case 1
            ...
            lc.E.out = 0.8*lc.E.out_scatter + 0.2*lc.E.out_uniform;
        case 2
...
%     screen.E.out = screen.E.in.*exp(1i*laser.k*screen.phase); % Light field after reflection on screen
    ...
    if plot_all_I
        ...
        title(['Intensity at retina. SC = ',num2str(round(sc(m),2))])
